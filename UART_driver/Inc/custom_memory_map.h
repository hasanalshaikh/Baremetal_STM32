...
#ifndef CUSTOM_MEMORY_MAP_H_
#define CUSTOM_MEMORY_MAP_H_
...
#define USART2_OFFSET		(0x4400UL) //page 54
...
//Every register is 4 bytes or 32 bits long.
typedef struct
{
  volatile uint32_t DUMMY[12];		//12*4=48 bytes padding because offset of AHB1ENR is 0x30
  volatile uint32_t AHB1ENR;       /*!< RCC AHB1 peripheral clock register,                          Address offset: 0x30 */
  volatile uint32_t DUMMY2[4];	   //4*4 =16 bytes padding, because offset is 0x40
